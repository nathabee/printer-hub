## TODO 2.0.x — Spaghetti ML Engine

 
The 2.0.x series focuses on machine-learning based detection, trained and validated against the datasets created during 0.7.x. 

 
# 2.0.x — Spaghetti ML Engine

## 2.0.0 — ML Dataset Preparation and First Model
...
## 2.0.3+ — ML Optimization Iterations
