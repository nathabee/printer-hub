/* 
File: src/main/java/printerhub/serial/JSerialCommPortAdapter.java

Purpose:

wraps the real library com.fazecast.jSerialComm.SerialPort
*/
...
public class JSerialCommPortAdapter implements SerialPortAdapter {
