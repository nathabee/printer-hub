package spaghettichef.shared.config;
...
public final class RuntimeDefaults {
    ...
    public static final String API_PORT_PROPERTY = "spaghettichef.api.port";
    public static final int DEFAULT_API_PORT = 8080;

    public static final String MONITORING_INTERVAL_SECONDS_PROPERTY = "spaghettichef.monitoring.intervalSeconds";
    public static final long DEFAULT_MONITORING_INTERVAL_SECONDS = 5L;
    public static final int ERROR_EXIT_CODE = 1;

    public static final String DATABASE_FILE_PROPERTY = "spaghettichef.databaseFile";
    public static final String DEFAULT_DATABASE_FILE = "spaghettichef.db";
