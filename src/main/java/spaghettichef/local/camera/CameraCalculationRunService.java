...
import spaghettichef.local.camera.analysis.CalculationEngineAdapterType;
import spaghettichef.local.camera.analysis.CalculationEngineConfiguration;
import spaghettichef.local.camera.analysis.CalculationEngineRegistry;
import spaghettichef.local.camera.analysis.CalculationEngineResult;
import spaghettichef.local.camera.analysis.CalculationEngineStatus;
import spaghettichef.local.camera.analysis.ExternalCliAnalyzerException;
import spaghettichef.local.camera.analysis.SpaghettiCalculationEngine;
