    ...
    <section class="detail-card">
      ...
      <div class="metric-grid">
        <div class="summary-card">
          ...
          <strong>${escapeHtml(renderStatusLabel(printer, printer.state || "UNKNOWN"))}</strong>
        </div>
        <div class="summary-card">
      ...
      <div class="two-column-grid">
        ...
        <div class="panel-card">
          <h3>Current issue</h3>
          <div class="message-value">${escapeHtml(printer.errorMessage || "No active error recorded.")}</div>
        </div>
      </div>
    </section>
  `;
