...
import spaghettichef.local.SerialCommunicationException;
...
import spaghettichef.local.persistence.PrinterSnapshotStore;
...
class PrinterMonitoringTaskTest {
    ...
    void invalidDatabasePathDoesNotCrashTaskAndCacheStillUpdates() {
        System.setProperty("spaghettichef.databaseFile", tempDir.toString());
    ...
    private int countRows(String tableName) throws Exception {
        try (Connection connection = spaghettichef.local.persistence.Database.getConnection();
